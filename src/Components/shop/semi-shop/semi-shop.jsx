...
const SemiShop = () => {
  ...
  const decide_page = () => {
    switch (page_slug) {
      ...
      case "امتحان-نهایی-دوازدهم":
        return [34, 67, 22, 26, 24, 39, 62, 23];
  ...
  const get_description = () => {
    switch (page_slug) {
      ...
      case "کلاس-های-اورژانسی":
        return "فکر این نباش که دیر شده! کلاس‌های اورژانسی کاد برای شما این فرصت رو فراهم کرده که خیلی سریع و اورژانسی تا دیر نشده به درک درستی از مفاهیم و به آمادگی کامل برسی.";
      default:
        return "";
    }
  };
  const get_keywords = () => {
    switch (page_slug) {
      ...
      case "کلاس-های-اورژانسی":
        return "کلاس‌های اورژانسی, اورژانسی کاد, دم امتحان, کلاس های اورژانسی, کلاس های اورژانسی دم امتحان, آمادگی امتحان";
      default:
        return "";
    }
  };
