    ...
    : [
        [
          ...
          },
          {
            ...
            descriptions:
              "دوره امتحان نهایی برای آمادگی هرچه بیشتر شما دانش آموزان عزیز تهیه و تنظیم شده. تو کلاس های این دوره تمامی مباحثی که نیاز دارید رو میتونید به راحتی یادبگیرید و با خیال راحت برای امتحان نهایی آماده بشید",
            aparat_link: "",
            kelases: [
              22, 23, 24, 26, 34, 37, 38, 39, 40, 41, 42, 43, 44, 61, 62, 63,
              64, 65, 68,
            ],
            image_link:
          ...
          },
          {
            ...
            descriptions:
              "دوره مبحثی نیاز خیلی از دانش آموزان کاد و بقیه موسسات است. به کمک دوره مبحثی میتونید بدون هزینه اضافی فقط قسمتی که مشکل دارید رو به راحتی یاد بگیرید و خیالتون برای همیشه از اون مبحث راحت باشه.",
            aparat_link: "",
