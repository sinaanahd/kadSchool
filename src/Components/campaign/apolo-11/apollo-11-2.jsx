...
const Apollo_11_2 = () => {
  ...
  const box_ref = useRef(false);
  const all_video = useRef(false);
  const [show_more_videos, set_show_more_videos] = useState(false);
  const [filtered_videos, set_filtered_videos] = useState([]);
  const [active_more, set_active_more] = useState(false);
  const [active_course, set_active_course] = useState("همه درس ها");
  ...
  const find_active = (id) => {
    const active_more = videos.find((v) => v.id === id);
    set_active_more(active_more);
    // setState({ active_more }, () => {
  ...
  const filter_videos = (name) => {
    ...
    // setState({ filtered_videos });
    set_filtered_videos(filter_videos);
  };
  return (
    <>
      <Helmet>
        ...
        <section className="welcome-to-prize-part mm-width">
          <div className="welcome-text-wrapper">
            ...
            <p className="welcome-text">
              ...
              این نمونه تدریس ها سخت ترین مبحث درس ها با بهترین آموزش اساتید کاد
              برای شماست. کلی نمونه تدریس متناسب با رشته و مبحث براتون آماده
              کردیم ؟
            </p>
            <p
              className="ready-text"
              onClick={() => {
                const rect = all_video.current.getBoundingClientRect();
                const offset =
          ...
          <div className="top-samples-wrapper">
            <div className="top-sample">
              <div className="top-sample-video">
                <AparatVideo src={videos[1].src} />
              </div>
              <h3 className="h3-title">{videos[1].description}</h3>
            ...
            <div className="top-sample">
              <div className="top-sample-video">
                <AparatVideo src={videos[2].src} />
              </div>
              <h3 className="h3-title">{videos[2].description}</h3>
              <p className="top-sample-desc">
                استاد فیض آبادی برای شما در چند جلسه مبحث مهم قافیه از درس علوم
                و فنون رو بهتون آموزش میده.
              </p>
            </div>
            <div className="top-sample">
              <div className="top-sample-video">
                <AparatVideo src={videos[3].src} />
              </div>
              <h3 className="h3-title">{videos[3].description}</h3>
              <p className="top-sample-desc">
                استاد ترکمان با مینی دوره ترجمه در درس عربی انسان نکته های زیادی
                برای گفتن بهتون داره. این مینی دوره رو از دست ندید.
              </p>
            </div>
          </div>
        </section>
        <section className="prizes-part" ref={all_video}>
          ...
          <div
            className={
              show_more_videos ||
              (filtered_videos.length !== 0 && filtered_videos.length < 5)
            ...
            <div className="sample-detials">
              ...
              <div className="subject-picker-wrapper">
                <span
                  ...
                  onClick={() => {
                    // setState({ show_options: !show_options });
                    set_show_options(!show_options);
                  }}
                >
                  <span className="option-text">{active_course}</span>
                  <img
                    src={arrow_img}
                    width={24}
                    height={14}
                    alt="فلش"
                    className={show_options ? "rotate" : ""}
                  />
                </span>
                <div
                  className={
                ...
                >
                  <span
                    ...
                    onClick={() => {
                      ...
                      //   show_options: false,
                      // });
                      set_active_course("همه درس ها");
                      set_show_options(false);
                      filter_videos("همه درس ها");
                    }}
                  >
                    همه درس ها
                  </span>
                  {video_options().map((name, i) => (
                    <span
                      key={i++}
                      className="pick-subject-item"
                      onClick={() => {
              ...
              <p className="sample-stage-desc">
                ساعت ها ویدیو از سخت ترین مباحث انسانی برای شما در این قسمت قرار
                داده شده. شما می‌تونید نمونه تدریس ها و مینی دوره های زیادی برای
                درس های{" "}
                ...
                رو با بهترین اساتید کاد به رایگان تماشا کنید. اساتید کاد در این
                کمپین برای شما این ویدیو ها رو آماده کردن و می تونید با انتخاب
                درس مورد نظرتون نمونه تدریس و مینی دوره ها رو به راحتی مشاهده
                کنید.
              </p>
            </div>
          ...
          {filtered_videos.length > 5 || filtered_videos.length === 0 ? (
            <div
              className="show-more-videos"
              onClick={() => {
                // const show_more_videos = !show_more_videos;
                // setState({ show_more_videos });
                set_show_more_videos(!show_more_videos);
              }}
            >
              <span className="text">
                مشاهده ویدیو های {!show_more_videos ? "بیشتر" : "کمتر"}
              </span>
              <span className={show_more_videos ? "arrows rotate" : "arrows"}>
            ...
            <div className="similar-courses-wrapper">
              ...
              <div className="similar-courses">
                {active_more.kelasses_id.map((k_id) => (
                  ...
                  >
                    <img
                      src={kelasses.find((k) => k.kelas_id === k_id).image_link}
                      alt={
...
// export default Apollo_11_2;
// class Apollo_11_22 extends Component {
//   constructor(props) {
//     super(props);
//     box_ref = React.createRef();
//     all_video = React.createRef();
//   }
//   state = {
